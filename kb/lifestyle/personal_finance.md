...
In general, it's best to [max out the contributions](https://www.irs.gov/retirement-plans/plan-participant-employee/retirement-topics-401k-and-profit-sharing-plan-contribution-limits) to retirement accounts (e.x. 401(k), IRA, etc.) as early and often as possible. Besides taking adavantage of a possible employer match, contributing to a [Traditional 401(k) with pre-tax dollars](https://www.finra.org/investors/insights/beginners-guide-401ks), directly reduces your taxable income (as well as growing tax-free, as opposed to taxable accounts like a savings account where taxes on dividends are due every year). Taxes [on income are paid when distributing in retirement](https://www.investopedia.com/ask/answers/112515/are-401k-contributions-tax-deductible.asp), unless a Roth 401(k) type is used, where taxes are paid on immediate contributions, but no taxes are paid in retirement. In general, the retirement type you should contribute to is:
- **Traditional:** if you expect to be in a _lower income bracket_ in retirement than you are now (for most people, especially if you are a high-earner now).
- **Roth:** if you expect to be in a _higher income bracket_ in retirement; this could also be a bet made that tax brackets may increase in the future compared to now.

Note though that above a certain Modified Adjusted Gross Income (MAGI), [you may not be able to contribute to Roth IRAs at all, or deduct the contribution made in a Traditional IRA](https://www.nerdwallet.com/article/investing/ira-contribution-limits). However, there are other tax-advantaged accounts you can contribute to like:
- Contributing to a Health Savings Account (HSA) if enrolled in a high-deductible health insurance plan, as the [funds may be invested by your broker and withdrawn in retirement](https://www.bankrate.com/retirement/using-your-hsa-as-a-retirement-plan/#:~:text=In%20addition%20to%20using%20an,used%20for%20qualified%20medical%20expenses.).
- Using a [mega backdoor Roth](https://www.fidelity.com/learning-center/personal-finance/mega-backdoor-roth) to contribute after-tax dollars, after already hitting a traditional 401(k) contribution limit.

You can also [withdraw- with penalty- or even take a loan out against your 401(k)- with interest paid directly back to yourself!- if needed](https://www.fidelity.com/viewpoints/financial-basics/taking-money-from-401k). Though note, like taking money from any investment account, this reduces the amount of principal gaining interest/in the market while paying back the loan.
