...
* [Fail2ban](https://www.fail2ban.org/wiki/index.php/Main_Page) to block connections that fail SSH after a set number of times.
...
* [OWASP Cheat Sheet](https://cheatsheetseries.owasp.org/): references and good security practices for builders in order to secure their applications.
