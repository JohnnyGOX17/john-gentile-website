...
## FPGA/ASIC-Specific Security

### Reverse Engineering

* [Reverse Engineering: FPGA vs ASIC](https://www.isec.tugraz.at/wp-content/uploads/2020/07/reverse_engineering_fpga_asic.pdf)
* [HAL](https://github.com/emsec/hal): a comprehensive netlist reverse engineering and manipulation framework.
* [bitfiltrator](https://github.com/epfl-vlsc/bitfiltrator): a general approach for reverse-engineering Xilinx bitstream formats
* [debit](https://github.com/djn3m0/debit): reverse-engineering tools for FPGA bitstreams (older/abandoned repo)
* [Project X-Ray (Xilinx 7-series)](https://github.com/SymbiFlow/prjxray)
* [icestorm (iCE40 FPGAs)](https://github.com/cliffordwolf/icestorm)
* [Project Trellis (ECP5s)](https://github.com/SymbiFlow/prjtrellis)
